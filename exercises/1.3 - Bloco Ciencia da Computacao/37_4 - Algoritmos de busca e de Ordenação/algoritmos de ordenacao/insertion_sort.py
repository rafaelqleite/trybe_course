...
# esteja inversamente ordenado, teremos uma complexidade de O(n²) .
# Isto se repete também em média, para arrays parcialmente ordenados.
# Porém se inicialmente o array estiver ordenado, este algoritmo terá
# complexidade O(n) , pois só fara a iteração de todos os elementos, e não
