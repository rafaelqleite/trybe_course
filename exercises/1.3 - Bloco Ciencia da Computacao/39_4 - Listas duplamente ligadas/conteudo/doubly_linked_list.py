...
if __name__ == "__main__":
    ...
    # saída:
    # DoublyLinkedList(len=1 value=
    # Node(value=HEAD next=Node(value=1 next=Node(value=TAIL next=None))))

    doubly_linked_list.insert_first(2)
    print(doubly_linked_list)
    # saída:
    # DoublyLinkedList(len=2 value=
    # Node(value=HEAD next=Node(value=2 next=Node(value=1 next=
    # Node(value=TAIL next=None)))))

    doubly_linked_list.insert_last(3)
    print(doubly_linked_list)
    # saída:
    # DoublyLinkedList(len=3 value=
    # Node(value=HEAD next=Node(value=2 next=Node(value=1 next=
    # Node(value=3 next=Node(value=TAIL next=None))))))

    doubly_linked_list.remove_last()
    print(doubly_linked_list)
    # saída:
    # DoublyLinkedList(len=2 value=Node(value=HEAD next=
    # Node(value=2 next=Node(value=1 next=Node(value=TAIL next=None)))))

    doubly_linked_list.remove_first()
    print(doubly_linked_list)
    # saída: DoublyLinkedList(len=1 value=
    # Node(value=HEAD next=Node(value=1 next=Node(value=TAIL next=None))))
    ...
    # Node(value=1 next=Node(value=5 next=Node(value=TAIL next=None)))))

    doubly_linked_list.remove_at(0)
    print(doubly_linked_list)
    # saída:
    # DoublyLinkedList(len=1 value=
    # Node(value=HEAD next=Node(value=5 next=Node(value=TAIL next=None))))
    ...
    print(doubly_linked_list.get_element_at(3))
